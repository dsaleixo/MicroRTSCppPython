...
from MicroRTS_NB import Unit,UnitAction,ResourceUsage,GameState,AStarPathFinding
...
class Harvest(AbstractAction):
    ...
    def completed(self, gs):
        return gs.getPhysicalGameState().getUnit(self._target.getID(),self._target.getPlayer())==None;
